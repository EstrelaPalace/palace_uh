  ...
  "01" : 
    {
      ...
      "TV": {
        "MARCA": "SAMSUNG",
        "POSSUITV": "NÃO",
        "POSSUICONTROLEDATV":"NÃO",
        "POLEGADAS": "32"
      },
      "APARELHODEMIDIA": {
        "MODELO":"NÃO POSSUÍ",
        "POSSUICONTROLEDEMIDIA":"NÃO",
        "CONTA": "",
        "SENHA": ""
      },
      "MODALIDADE": 0
  ...
  "12" : 
    {
      ...
      "CAMAS": {
        ...
        "KINGSIZE": "0",
        "SOLTEIRO": "0",
        "CAPACIDADE":"1 CAM CASAL + 2 SOLT"
      },
      "SECADORES": {
        "POSSUISECADOR": "SIM",
        "VOLTAGEM": "220vh",
        "CONDICAO": "NÃO FUNCIONA",
        "MARCA": "VERIFICAR"
      },
      "TELEFONE": {
        "MARCA" : "-",
  ...
  "22" : 
    {
      ...
      "TELEFONE": {
        ...
        "MODELO" : "VERIFICAR",
        "RAMAL": "122",
        "POSSUITELEFONE":"SIM / NÃO FUNCIONA"
      },
      "TV": {
        "MARCA": "NORTH TEC",
        "POSSUITV": "SIM",
  ...
  "24" : 
    {
      ...
      "SECADORES": {
        "POSSUISECADOR": "SIM",
        "VOLTAGEM": "220vh",
        "CONDICAO": "FUNCIONA / BARULHO DESAGRADÁVEL",
        "MARCA" : "VERIFICAR"
      },
      "TELEFONE": {
        "CONDICAO": "FUNCIONA",
  ...
  "36" : 
    {
      ...
      "APARELHODEMIDIA": {
        "MODELO":"VERIFICAR",
        "POSSUICONTROLEDEMIDIA":"VERIFICAR",
        "CONTA" : "VERIFICAR",
        "SENHA" : "VERIFICAR"
      }
    },
...
function displayRoom(data){
  return (
    `
    ${createArConditionerStatus(data)}
    ${createBedsStatus(data)}
    ${createHairdryerStatus(data)}
    ${createTelephoneStatus(data)}
    ${createTvStatus(data)}
    ${createMediaDeviceStatus(data)}
    `
  )
}

function createArConditionerStatus(data) { 
  return(
  `
    <!-- ARCONDICIONADO -->
...
function createHairdryerStatus(data){
  console.log(data)
  return(`
    <!-- SECADORES -->
      <div class="card-div" style="padding: 10px; width: 22rem; display: flex; flex-direction: column; justify-content: space-between; background-color: #ffffff; border-radius: 2%;">
...
let uhChoosed = document.querySelector('.uhChoosed')
const container = document.querySelector(".container")

const li = document.querySelectorAll(".uh-link")
